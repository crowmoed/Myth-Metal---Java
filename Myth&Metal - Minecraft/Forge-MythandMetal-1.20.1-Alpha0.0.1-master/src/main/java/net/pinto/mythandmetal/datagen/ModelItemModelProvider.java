...
public class ModelItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.ARBINITE_HELMET);
        trimmedArmorItem(ModItems.ARBINITE_CHESTPLATE);
        trimmedArmorItem(ModItems.ARBINITE_LEGGINGS);
        trimmedArmorItem(ModItems.ARBINITE_BOOTS);

        /*trimmedArmorItem(ModItems.SCORIUM_HELMET);
        trimmedArmorItem(ModItems.SCORIUM_CHESTPLATE);
        trimmedArmorItem(ModItems.SCORIUM_LEGGINGS);
        trimmedArmorItem(ModItems.SCORIUM_LEGGINGS);*/
    }
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = MythandMetal.MOD_ID; // Change this to your mod id
