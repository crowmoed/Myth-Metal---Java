...
public class MagmaraakhEntity extends Animal {
    public MagmaraakhEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(MagmaraakhEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MaghmaraakhAttack(this, 1.0D, true));
